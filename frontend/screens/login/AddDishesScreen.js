...
const AddDishesScreen = ({navigation}) => {
  ...
  const handleAdd = () => {
    for (let i = 0; i <= dishItems.length; i++) {
        ...
        if(!isIn) {setDishItems([{key: i, name: '', description: '', price: '', imgLink: 'https://pixsector.com/cache/d69e58d4/avbfe351f753bcaa24ae2.png', allergies: {nuts: false, dairy: false, gluten: false}}, ...dishItems]); break;}
    }
