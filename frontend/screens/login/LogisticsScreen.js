    ...
    <KeyboardAwareScrollView style={{flex:1, paddingTop: 16, marginHorizontal: 8}}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          <ShadowCard2>
            ...
            <ToggleText text ="Sunday" isSelected={operatingDays.Sunday.isActive} setIsSelected={(value) => setDayState('Sunday',value)} startTime ={operatingDays.Sunday.startTime} setStartTime={(value) => setDayStartTime('Sunday',value)} endTime ={operatingDays.Sunday.endTime} setEndTime={(value) => setDayEndTime('Sunday',value)} timeActive={!operatingDays.preorderOnly}/>
            <ToggleText text ="Monday" isSelected={operatingDays.Monday.isActive} setIsSelected={(value) => setDayState('Monday',value)} startTime ={operatingDays.Monday.startTime} setStartTime={(value) => setDayStartTime('Monday',value)} endTime ={operatingDays.Monday.endTime} setEndTime={(value) => setDayEndTime('Monday',value)} timeActive={!operatingDays.preorderOnly}/>
            <ToggleText text ="Thuesday" isSelected={operatingDays.Thuesday.isActive} setIsSelected={(value) => setDayState('Thuesday',value)} startTime ={operatingDays.Thuesday.startTime} setStartTime={(value) => setDayStartTime('Thuesday',value)} endTime ={operatingDays.Thuesday.endTime} setEndTime={(value) => setDayEndTime('Thuesday',value)} timeActive={!operatingDays.preorderOnly}/>
            <ToggleText text ="Wednesday" isSelected={operatingDays.Wednesday.isActive} setIsSelected={(value) => setDayState('Wednesday',value)} startTime ={operatingDays.Wednesday.startTime} setStartTime={(value) => setDayStartTime('Wednesday',value)} endTime ={operatingDays.Wednesday.endTime} setEndTime={(value) => setDayEndTime('Wednesday',value)} timeActive={!operatingDays.preorderOnly}/>
            <ToggleText text ="Thursday" isSelected={operatingDays.Thursday.isActive} setIsSelected={(value) => setDayState('Thursday',value)} startTime ={operatingDays.Thursday.startTime} setStartTime={(value) => setDayStartTime('Thursday',value)} endTime ={operatingDays.Thursday.endTime} setEndTime={(value) => setDayEndTime('Thursday',value)} timeActive={!operatingDays.preorderOnly}/>
            <ToggleText text ="Friday" isSelected={operatingDays.Friday.isActive} setIsSelected={(value) => setDayState('Friday',value)} startTime ={operatingDays.Friday.startTime} setStartTime={(value) => setDayStartTime('Friday',value)} endTime ={operatingDays.Friday.endTime} setEndTime={(value) => setDayEndTime('Friday',value)} timeActive={!operatingDays.preorderOnly}/>
