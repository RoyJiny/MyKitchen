        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          <View style={{ flexDirection:'row', justifyContent: 'space-between', alignContent: 'center', paddingRight: 16 }}>
            ...
            <Button2
              ...
              text ="Save"
              textColor = "black"
              disable = { (payLinks[0] == '' && payLinks[1] == '') ||  !(isOnlyFutureDelivery || operationDays[0].isActive || operationDays[1].isActive || operationDays[2].isActive || operationDays[3].isActive || operationDays[4].isActive || operationDays[5].isActive || operationDays[6].isActive)}
            />
            </TouchableOpacity>
          </View>
