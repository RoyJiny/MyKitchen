...
const OpenURLButton = ({ url, text, addLine }) => {
  ...
  return (
          ...
          <TouchableOpacity style={{paddingVertical: 8}} onPress={handlePress}>
            <Text style={{marginLeft: 16, textAlign: 'center', fontSize: 14, color:'#0066CC'}}>{text}</Text>
          </TouchableOpacity>
